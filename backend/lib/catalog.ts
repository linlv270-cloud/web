...
export const tagSeeds: Record<string, string[]> = {
  "我的身份": ["手作人", "设计师", "艺术家", "插画师", "摄影师", "非遗传承人", "非遗创作者", "工艺匠人", "独立出版人", "独立品牌主理人", "花艺师", "调香师", "甜品师", "烘焙师", "咖啡师", "茶艺师", "美食主理人", "酒饮主理人", "潮玩主理人", "古着主理人", "买手", "策展人", "音乐人", "乐队", "DJ", "舞者", "戏剧演员", "即兴演员", "脱口秀演员", "魔术师", "工作坊老师", "收藏者", "内容创作者", "AI从业者"],
