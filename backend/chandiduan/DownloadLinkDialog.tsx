      ...
      >
        ...
        <div style={{ padding: "20px 0" }}>
          ...
          <div style={{ textAlign: "left", marginBottom: 16 }}>
            <p style={{ fontSize: 12, color: "#767d77", margin: "0 0 6px" }}>下载链接</p>
            <div
              style={{
                background: "#f6f4ee",
        ...
        <p style={{ fontSize: 11, color: "#a2a7a1", margin: 0, display: "flex", alignItems: "center", justifyContent: "center", gap: 4 }}>
          <Clock size={12} />
