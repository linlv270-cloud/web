...
export const VizPage = forwardRef<HTMLDivElement, VizPageProps>(function VizPage({ creator, templateConfig }, ref) {
  ...
  const brandName = templateConfig?.brandName || "TDECOCOC";
        ...
        <div style={{ width: 420, flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
          {photoUrl ? (
            <img
              ...
              style={{ width: "100%", height: 520, objectFit: "cover", borderRadius: 4, display: "block" }}
            />
          ) : (
            <div
              style={{
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    gap: 6,
                    padding: "6px 14px",
                    border: selectedIds.size === 0 ? `1px solid ${C.line}` : `1px solid ${C.dangerSoft}`,
                    borderRadius: 6,
                    background: selectedIds.size === 0 ? C.surfaceSoft : C.dangerSoft,
                    cursor: selectedIds.size === 0 ? "not-allowed" : "pointer",
                    fontSize: 13,
                    color: selectedIds.size === 0 ? C.faint : C.danger,
