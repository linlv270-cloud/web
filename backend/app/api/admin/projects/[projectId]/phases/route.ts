...
import { listExecutionProjectPhases } from "../../../../../../lib/execution-projects";
...
export async function GET(
  ...
  return Response.json({ phases: listExecutionProjectPhases(projectId) }, { headers: { "cache-control": "no-store" } });
}
