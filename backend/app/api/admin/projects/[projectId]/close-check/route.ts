...
import { getProjectCloseCheck, projectOperationsErrorResponse } from "../../../../../../lib/execution-project-operations";
...
export async function GET(request: Request, { params }: { params: Promise<{ projectId: string }> }) {
  ...
  try { return Response.json(getProjectCloseCheck(projectId, adminPrincipalFromRequest(request)!)); } catch (error) { return projectOperationsErrorResponse(error); }
}
